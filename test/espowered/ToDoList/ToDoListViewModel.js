(function e(t, n, r) {
            ...
            (function (root, factory) {
                ...
                function addComment(type, value, start, end, loc) {
                    ...
                    assert(assert._expr(assert._capt(assert._capt(typeof start, 'arguments/0/left') === 'number', 'arguments/0'), {
                        ...
                        filepath: '/Users/matsu_chara/Documents/sand/knock-sample/test/ToDoList/ToDoListViewModel.coffee',
                        line: 5555
    ...
    30: [
        ...
        {
            './built-in/assertion': 26,
            './built-in/binary-expression': 27,
            './built-in/diagram': 28,
            './built-in/file': 29,
            './default-options': 31,
            './string-width': 34,
    ...
    39: [
        ...
        { '/Users/matsu_chara/Documents/sand/knock-sample/node_modules/power-assert/node_modules/empower/node_modules/escallmatch/node_modules/esprima/esprima.js': 19 }
    ],
    40: [
        function (require, module, exports) {
            (function (root, factory) {
    ...
    41: [
        ...
        { './javascript/diff_match_patch_uncompressed.js': 42 }
    ],
    42: [
        function (require, module, exports) {
    ...
    46: [
        ...
        { '/Users/matsu_chara/Documents/sand/knock-sample/node_modules/power-assert/node_modules/empower/node_modules/escallmatch/node_modules/espurify/node_modules/traverse/index.js': 23 }
    ],
    47: [
        function (require, module, exports) {
            'use strict';
    ...
    51: [
        ...
        { './../../bower_components/moment/moment.js': 8 }
    ],
    52: [
        function (require, module, exports) {
            var ToDo, ToDoListViewModel, ko, moment, bind = function (fn, me) {
                    return function () {
        ...
        {
            './../../bower_components/knockout/dist/knockout.js': 7,
            './../../bower_components/moment/moment.js': 8,
            './ToDo': 51
        }
    ],
    53: [
        function (require, module, exports) {
            var ToDo, ToDoListViewModel, assert;
            ...
            describe('ToDoListViewModel', function () {
                ...
                it('has empty task', function () {
                    return assert(assert._expr(assert._capt(assert._capt(assert._capt(assert._capt(t, 'arguments/0/left/object/callee/object').todos(), 'arguments/0/left/object').length, 'arguments/0/left') === 0, 'arguments/0'), {
                        content: 'assert(t.todos().length === 0)',
                        filepath: '/Users/matsu_chara/Documents/sand/knock-sample/test/ToDoList/ToDoListViewModel.coffee',
                        line: 14944
                    }));
                });
                return describe('add task', function () {
                    ...
                    it('can add task', function () {
                        ...
                        t.deadline('1/1 1:11');
                        t.add();
                        return assert(assert._expr(assert._capt(assert._capt(assert._capt(assert._capt(t, 'arguments/0/left/object/callee/object').todos(), 'arguments/0/left/object').length, 'arguments/0/left') === 1, 'arguments/0'), {
                            content: 'assert(t.todos().length === 1)',
                            filepath: '/Users/matsu_chara/Documents/sand/knock-sample/test/ToDoList/ToDoListViewModel.coffee',
                            line: 14955
                        }));
                    });
                    it('can\'t add task with invalid params', function () {
                        t.text('');
                    ...
                    describe('remove', function () {
                        return it('remove task', function () {
                            t.text('test_task');
                            t.deadline('1/1 1:11');
                            t.add();
                            t.remove(t.todos()[0]);
                    ...
                    describe('print', function () {
                        return it('return string', function () {
                            return assert(assert._expr(assert._capt(assert._capt(typeof assert._capt(assert._capt(t, 'arguments/0/left/argument/callee/object').printToDo(assert._capt(new ToDo('test_task', '1/1 1:11'), 'arguments/0/left/argument/arguments/0')), 'arguments/0/left/argument'), 'arguments/0/left') === 'string', 'arguments/0'), {
                                content: 'assert(typeof t.printToDo(new ToDo("test_task", "1/1 1:11")) === "string")',
                                filepath: '/Users/matsu_chara/Documents/sand/knock-sample/test/ToDoList/ToDoListViewModel.coffee',
                                line: 14974
                            }));
                        });
                    });
                    return describe('setIsTextFocused', function () {
                        return it('set isTextFocused property', function () {
                            t.setIsTextFocused();
                            return assert(assert._expr(assert._capt(assert._capt(t, 'arguments/0/callee/object').isTextFocused(), 'arguments/0'), {
                                content: 'assert(t.isTextFocused())',
                                filepath: '/Users/matsu_chara/Documents/sand/knock-sample/test/ToDoList/ToDoListViewModel.coffee',
                                line: 14980
                            }));
                        });
        ...
        {
            '../../src/ToDoList/ToDo': 51,
            '../../src/ToDoList/ToDoListViewModel': 52,
            'power-assert': 9
        }
    ]
}, {}, [53]));